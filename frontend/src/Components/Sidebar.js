                ...
                <div class="sidebar-header flex items-center justify-center py-4">
                    <div class="inline-flex">
                        <a href="#" class="inline-flex flex-row items-center">
                            ...
                            <span class="leading-10 text-brown-600 text-2xl font-bold ml-1 uppercase">Pika Cafe</span>
                        </a>
                    </div>
                </div>
                <div class="sidebar-content px-4 py-6">
                    <ul class="flex flex-col w-full">
                        <li class="my-px">
                            <a
                                href="/dashboard"
                                class="flex flex-row items-center h-10 px-3 rounded-lg text-yellow-600 hover:bg-yellow-100 hover:text-yellow-800 font-base"
                            >
                        ...
                        <li class="my-px">
                            ...
                            >
                                <span class="mr-2 flex items-center justify-center text-lg text-gray-400">
                                    <FontAwesomeIcon icon={faTable} color="yellow" />
                                </span>
                        ...
                        <li class="my-px">
                            ...
                            >
                                <span class="mr-3 flex items-center justify-center text-lg text-gray-400">
                                    <FontAwesomeIcon icon={faUtensils} color="yellow" />
                                </span>
                        ...
                        <li class="my-px">
                            ...
                            >
                                <span class="mr-3 flex items-center justify-center text-lg text-gray-400">
                                    <FontAwesomeIcon icon={faHistory} color="yellow" />
                                </span>
                        ...
                        <li class="my-px" onClick={() => this.logOut()}>
                            <a
                                href="/"
                                class="flex flex-row items-center h-10 px-3 rounded-lg text-yellow-600 hover:bg-yellow-100 hover:text-yellow-800 mt-32"
                            >
