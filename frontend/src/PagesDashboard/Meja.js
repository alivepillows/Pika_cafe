...
export default class Meja extends React.Component {
    ...
    handleSave = (e) => {
        ...
        if (this.state.action === "insert") {
            let url = "http://localhost:8000/meja/add"
    ...
    handleDrop = (id_meja) => {
        let url = "http://localhost:8000/meja/delete/" + id_meja
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" onSubmit={(event) => this.handleSave(event)}>
                                    <div>
                                        ...
                                        <input type="text" name="nomor_meja" id="nomor_meja" value={this.state.nomor_meja} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan number of nomor_meja" required />
                                    </div>
                                    <div>
