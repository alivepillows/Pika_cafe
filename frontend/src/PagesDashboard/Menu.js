...
export default class Menu extends React.Component {
    ...
    handleSave = (e) => {
        ...
        if (this.state.action === "insert") {
            let url = "http://localhost:8000/menu/add"
            ...
            let url = "http://localhost:8000/menu/add" + this.state.id_menu
    ...
    handleDrop = (id) => {
        let url = "http://localhost:8000/menu/delete/" + id
    ...
    getmenu = () => {
        let url = "http://localhost:8000/menu/get";
        axios
                        ...
                        <div class="mb-4">
                            <div className="flex items-center">
                                <div className="flex rounded w-1/2">
                                    <input
                                        type="text"
                                        className="w-4/6 block w-full px-4 py-2 bg-white border rounded-md focus:border-yellow-400 focus:ring-yellow-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                        placeholder="Search..."
                                        name="keyword"
                                        value={this.state.keyword}
                                        onChange={this.handleChange}
                                    />
                                    <button className="w-1/8 ml-2 px-4 text-white bg-yellow-100 border border-1 border-yellow-600 rounded hover:bg-yellow-200" onClick={this._handleFilter}>
                                        <FontAwesomeIcon icon={faSearch} color="yellow" />
                                    </button>
                                    {this.state.role === "admin" &&
                                        <button className="w-1/5 ml-2 px-4 text-white bg-yellow-600 rounded hover:bg-yellow-700" onClick={() => this.handleAdd()}>
                                        ...
                                        <div class="CardEvent" key={index}>
                                            <div class="max-w-sm rounded overflow-hidden shadow-lg border-2 border-gray-200 bg-gray-100">
                                                <div className='container'>
                                                    <img class="w-full h-48" src={"http://localhost:8000/foto_menu/" + item.gambar} />
                                                    {this.state.role === "admin" &&
                                                        <>
                                                ...
                                                <div class="px-6 py-4">
                                                    ...
                                                    <div class="font-bold text-xl mb-2 text-yellow-600">Harga: {item.harga}</div>
                                                    ...
                                                    <div class="font-bold text-xl mb-2 text-yellow-600">Jenis: {item.jenis}</div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" onSubmit={(event) => this.handleSave(event)}>
                                    <div>
                                        ...
                                        <input type="text" name="nama_menu" id="nama_menu" value={this.state.nama_menu} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan nama makanan" required />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <textarea rows="3" type="text" name="deskripsi" id="deskripsi" value={this.state.deskripsi} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan deskripsi makanan" />
                                    </div>
                                    <div>
                                    ...
                                    <button type="submit" class="w-full text-white bg-gradient-to-br from-purple-600 to-yellow-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Simpan</button>
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative bg-white rounded-lg">
                            ...
                            <div class="p-6">
                                ...
                                <div class="px-2 py-4">
                                    ...
                                    <div class="font-bold text-xl mb-2 text-yellow-600">{this.state.harga}/night</div>
