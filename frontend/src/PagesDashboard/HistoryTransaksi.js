...
handleAddTransaksi = () => {
  let form = {
    ...
    nama_user: this.state.nama_user,
        ...
        let url = "http://localhost:8000/transaksi/add "
  ...
  getTransaksi = () => {
    let url = "http://localhost:8000/transaksi/get";
            ...
            <div className="flex mt-2 flex-row-reverse">
              <div className="flex rounded w-1/3 mr-4">
                ...
                {this.state.role === "kasir" && (
                  <button
                    className="w-1/3 ml-2 px-4 text-white bg-yellow-600 rounded hover:bg-yellow-700"
                    onClick={() => this.handleAdd()}><FontAwesomeIcon icon={faPlus} size="" /> Add
                  </button>
                )}
              </div>
            </div>
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      onChange={this.handleChange}
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800"
                  ...
                  <button
                    type="submit"
                    className="w-full text-white bg-gradient-to-br from-purple-600 to-yellow-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                  >
                    Simpan
                  </button>
                </form>
