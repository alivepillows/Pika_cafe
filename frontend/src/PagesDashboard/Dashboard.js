  ...
  constructor() {
    ...
    if (localStorage.getItem("token")) {
      if (
        ...
        window.alert("You're not admin, manajer or kasir!");
        window.location = "/";
      }
    }
  }
  ...
  <div class="grid gap-10 lg:grid-cols-2">
    <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
      <div class="max-w-xl mb-6">
        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-yellow-900 sm:text-4xl sm:leading-none">
          Welcome to Pika Cafe<br class="hidden md:block" />
          Your Serene Haven for Business and Leisure
        </h2>
        <p class="text-base text-gray-700 md:text-lg">
        Welcome to Pika cafe, where luxury meets tranquility. Nestled in a picturesque location, our hotel offers a serene and enchanting ambiance, making it the perfect destination for both leisure and business travelers.
        </p>
      </div>
      <div>
      </div>
